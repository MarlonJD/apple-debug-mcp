...
- [ ] (2026-08-26 15:45Z) Move hosted CI from macOS-14 to the arm64 macOS-26 image after its Swift 5.10 toolchain could not resolve the current Swift 6.1/6.2 dependency graph; restore the current SDK/NIO pins and confirm the new CI run reaches package resolution.
