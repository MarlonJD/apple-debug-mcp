...
- [ ] (2026-08-26 16:14Z) Make the Mach-O regression test independent of whether the hosted Apple toolchain exposes a universal or thin `lldb-dap`, while retaining explicit thin-image parsing coverage.
