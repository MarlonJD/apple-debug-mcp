...
- [ ] (2026-08-26 16:34Z) Give the stdio MCP smoke enough bounded time for the hosted toolchain probe and require its actual response before validating the remaining transcript.
