...
| [Establish the Apple Debug MCP foundation](active/apple-debug-mcp-foundation.md) | Apple Debug MCP maintainers | implementing | 2026-08-25 | Local macOS/iOS Simulator product; physical-device and release gates remain explicit |
