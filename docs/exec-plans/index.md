...
| [Establish the Apple Debug MCP foundation](active/apple-debug-mcp-foundation.md) | Apple Debug MCP maintainers | implementing | 2026-08-27 | Foundation release published; current modern-device rerun is blocked by an unavailable CoreDevice tunnel |
