...
| Xcode builds | Build execution requires APPLE_DEBUG_ALLOW_XCODE_BUILD=1 and an explicit project, scheme, configuration, and destination | XcodeService.build | AppleXcodeTests and tool schema review | Maintainers; every build workflow change |
