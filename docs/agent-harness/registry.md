...
| iOS UI tree/action smoke | make ios-ui-tree-smoke | Exercise the standalone XCTest accessibility and action bridge | XCUITest attachment returns element records and tap/typeText/swipe/wait actions complete through MCP | Maintainers; explicit mutation-authorized task | verified |
