...
| iOS UI tree smoke | make ios-ui-tree-smoke | Exercise the standalone XCTest accessibility bridge | XCUITest attachment returns element records and stable identifiers through MCP | Maintainers; explicit mutation-authorized task | verified |
