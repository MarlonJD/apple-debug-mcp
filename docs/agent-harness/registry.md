...
| Debug session lifecycle | apple_debug_session_create/list/close | Create, inspect, and close an owned LLDB-DAP adapter session | Session ID appears, then adapter exits after close | Maintainers; session policy changes | verified |
