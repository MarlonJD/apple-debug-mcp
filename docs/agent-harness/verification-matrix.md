...
| macOS desktop backend | python3 scripts/debug_fixture_smoke.py | make check | LLDB launch, source/function/exception breakpoints, stop snapshot, modules, registers, stack/scopes, memory, disassembly, step, continue, and cleanup | Keep target mutation opt-in and respect adapter capability support | Maintainers; backend addition |
