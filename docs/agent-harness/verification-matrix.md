...
| iOS Simulator backend | make ios-fixture-smoke | make ios-debug-fixture-smoke and make ios-ui-tree-smoke | Build/install/launch/screenshot, LLDB attach/inspection, and XCUITest accessibility-tree evidence | Requires an available Simulator and explicit mutation gate | Maintainers; backend addition |
