...
| iOS Simulator backend | make ios-fixture-smoke; make xcode-artifact-smoke; make xcode-test-smoke | make ios-debug-fixture-smoke and make ios-ui-tree-smoke | Generic Xcode build returns app/dSYM artifacts; generic test returns xcresult summary; install/launch/screenshot, LLDB attach/inspection, accessibility tree, and UI-action evidence | Requires Xcode and, for target mutation, an available Simulator plus explicit mutation gate | Maintainers; backend addition |
