...
| Apple binary analysis | swift test --filter AppleBinaryIntelligenceTests | make check | Code signature, entitlements, dependencies, symbols, and dyld export report | Keep analyzers regular-file and output bounded | Maintainers; toolchain change |
