...
| Apple binary analysis | swift test --filter AppleBinaryIntelligenceTests | make check | Code signature, entitlements, dependencies, symbols, dyld exports, and Objective-C/Swift metadata reports | Keep analyzers regular-file and output bounded | Maintainers; toolchain change |
