...
Current attestation source commit: c7e3aa2b7b39d6231e175b3cdada56cb5300d91c.
...
| Logs, metrics, and traces are queryable when relevant | environment-contract.md, registry.md, and `apple_log_show` | Bounded unified-log result or justified N/A | [verified — bounded host/Simulator log adapter is documented and tested; metrics/traces remain N/A](evidence/coverage-05.json) |
