...
| --- | --- | --- | --- |
| Start read-only, then add gated control | Debugger operations can terminate or mutate a target | Discovery and analysis remain safe defaults; control is added only behind explicit policy and fixture proof | `DebugPolicy`, fixture smoke, and security contract |
